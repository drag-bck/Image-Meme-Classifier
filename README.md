...
3. Open CMD and go into the directry where you haved saved the code of this project.
4. In CMD type : ptyhon classify_meme.py <path of the image>. Ex. python classify_meme.py C:\Users\Comp\Desktop\Image.jpg
5. If the magic of maths worked correctly you should see a class to which the meme belong and how much my math is accurate in predecting the meme.
